...
namespace Texart.Plugins.Tests.Scripting.Diagnostics.TestHelpers
{
    ...
    public abstract class DiagnosticVerifier
    {
        ...
        /// </summary>
        protected virtual LanguageVersion CSharpLanguageVersion => LanguageVersion.Default;
        /// <summary>
        /// Get the CSharp source kind - to be implemented in non-abstract class
        /// </summary>
        protected virtual SourceCodeKind CSharpSourceCodeKind => SourceCodeKind.Regular;
        /// <summary>
        /// Get the CSharp source kind - to be implemented in non-abstract class
        /// </summary>
        ...
        private Project CreateProject(string[] sources)
        {
            ...
            var solution = new AdhocWorkspace()
                ...
                .WithProjectParseOptions(projectId, new CSharpParseOptions(
                    CSharpLanguageVersion, kind: CSharpSourceCodeKind, preprocessorSymbols: CSharpPreprocessorSymbols))
